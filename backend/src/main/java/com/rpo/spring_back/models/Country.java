...
public class Country {    //вместо того, чтобы для каждого поля делать методы чтения и записи
    ...
    // Обратное отношение к модели Developer. В этом отношении надо указать поле, которое
    // в противоположной модели используется как ссылка на нас – это сountry.
    // ***
    // Модель страны содержит ссылку на ее художников developers, точно также, артисты имеют ссылку на свою страну.
