package com.rpo.spring_back.auth;
...
public class AuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(String userName,
        ...
        Optional<com.rpo.spring_back.models.User> uu = userRepository.findByToken(String.valueOf(token));
        if (!uu.isPresent())
            throw new UsernameNotFoundException("user_is_not_found");
        com.rpo.spring_back.models.User u = uu.get();
